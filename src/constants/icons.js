...
export const food = require("../img/icon/food.jpg");
export const bike = require("../img/icon/bike.jpg");
export const car = require("../img/icon/car.jpg");
export const ship = require("../img/icon/delivery.png");
export const subscribe = require("../img/icon/subscribe.jpg");
export const doctor = require("../img/icon/doctor.jpg");
export const phone = require("../img/icon/pulsa.jpg");
export const more = require("../img/icon/more.jpg");
export const youTube=require("../assets/icons/youtube.png");
export const fb=require("../assets/icons/facebook.png");
